...
<Image data-aos="flip-left" data-aos-duration="3000" src={meabc} alt="me" height={200} width={200} className="rounded-full mb-4 hover:rounded-[10px] duration-700"></Image>
    <div className="text-center lg:w-2/3 w-full">
      ...
      I specialize in front-end development, where I bring designs to life using languages like HTML, CSS, and JavaScript. Whether it's creating responsive layouts, implementing interactive features, or optimizing performance, I thrive on the challenges of turning ideas into code.
      But I'm not just limited to the front end. I also have experience working with back-end technologies like Node.js and react.js and others
      </p>
     ...
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000">
        <img width="65" height="65" src="https://img.icons8.com/color/48/facebook.png" alt="facebook"/>
        </div>
        </Link>
      </div>
    </div>
